            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        ...
                        <form action="{{route('LoginAuth')}}" method="post" class="md-float-material">
                            @csrf
                            ...
                            <div class="auth-box">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control mt-4 mr-45" placeholder="Login" name="login">
                                    <span class="md-line"></span>
                                </div>
                                
                                <div class="input-group">
                                    <label for="" class="text-dark">Password</label>
                                    <input type="password" class="form-control mt-4" placeholder="Password" name="mdp">
                                    <span class="md-line"></span>
                                </div>
                        ...
                        <!-- end of form -->
                        @if (session('StatuM')) 
                            <div class="alert alert-danger mt-3 col-md-10 mx-auto">
                                {{session('StatuM')}}
                            </div>
                        @endif
                        @if (session('StatuL')) 
