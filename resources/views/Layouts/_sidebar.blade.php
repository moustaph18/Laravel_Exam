<nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div {{empty(session('personne')) || !empty(session('personne')) && session('personne')->Profil==2 ? 'hidden' : ''}}>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li {{empty(session('personne')) || !empty(session('personne')) && session('personne')->Profil==2 ? 'hidden' : ''}}>
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.forms" {{session('personne') ? 'hidden' : ''}}>Securiter</div>
                            <ul class="pcoded-item pcoded-left-item" {{session('personne') ? 'hidden' : ''}}>
